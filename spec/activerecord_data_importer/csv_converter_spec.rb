...
describe ActiverecordDataImporter::CsvConverter do
  describe "#convert_csv_to_hash" do
    context "no relation data" do
      it "success hash converted" do
        result = ActiverecordDataImporter::CsvConverter.convert_csv_to_hash File.expand_path "../../csv/char.csv", __FILE__
        expected_hash = [
    ...
    context "exist relation data of 1 to N" do
      it "success hash converted" do
        result = ActiverecordDataImporter::CsvConverter.convert_csv_to_hash File.expand_path "../../csv/char_and_skill.csv", __FILE__
        expected_hash = [
    ...
    context "exist relation data of 1 to 1" do
      it "success hash converted" do
        result = ActiverecordDataImporter::CsvConverter.convert_csv_to_hash File.expand_path "../../csv/char_and_element.csv", __FILE__
        expected_hash = [
    ...
    context "exist relation data of 1 to N and 1" do
      it "success hash converted" do
        result = ActiverecordDataImporter::CsvConverter.convert_csv_to_hash File.expand_path "../../csv/char_and_skill_and_effect.csv", __FILE__
        expected_hash = [
